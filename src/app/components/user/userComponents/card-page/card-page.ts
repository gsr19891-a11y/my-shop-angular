    ...
    this.productService.checkout().subscribe({
      next: (res) => {
        ...
        this.authService.getUser().subscribe({
          next: (res) => {
            this.productService.userEmail.set(res.data.email);
            this.productService.userName.set(res.data.firstName);

            console.log(this.productService.userEmail());
            this.productService
              .emailSend(this.productService.userEmail(), this.productService.userName())
              .subscribe({
                next: (res) => {
